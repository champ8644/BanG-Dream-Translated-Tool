...
Comment: 0,0:00:00.00,0:00:00.00,Text,,0,0,0,template noblank line keeptags,!retime('set',db[actor][j].t,db[actor][j+1].t)!!maxloop(#db[actor]-1)!{\\an5\\fs!fontSize!\\fscx!db[actor][j].p!\\fscy!db[actor][j].p!\\t(0,!db[actor][j+1].t-db[actor][j].t!,\\fscx!db[actor][j+1].p!\\fscy!db[actor][j+1].p!)\\move(!db[actor][j].x!,!db[actor][j].y!,!db[actor][j+1].x!,!db[actor][j+1].y!,0,!db[actor][j+1].t-db[actor][j].t!)}
...
Comment: 0,0:00:00.00,0:00:00.00,Text - Rectangle,,0,0,0,template noblank line keeptags,!retime('preline',-150,50)!{\\an5\\fscx0\\fscy0\\t(16.66,166.66,\\fscx100\\fscy100)\\move(!xcen!,!ytext0!,!xcen!,!ytext!,16.66,166.66)\\fs!size!}
Comment: 0,0:00:00.00,0:00:00.00,Text - Rectangle,,0,0,0,template noblank line keeptags,!retime('line',50,200)!{\\an5\\fscx100\\fscy100\\t(!$ldur-60!,!$ldur+140!,\\fscx0\\fscy0)\\move(!xcen!,!ytext!,!xcen!,!ytext0!,!$ldur-60!,!$ldur+140!)\\fs!size!}
...
Comment: 0,0:00:00.00,0:00:00.00,Text - Shout,,0,0,0,template noblank line keeptags loop 4,!retime('preline',-133.33+time[j],-133.33+time[j+1])!{\\an5\\fscx!progress[j]*100!\\fscy!progress[j]*100!\\t(time[j],time[j+1],\\fscx!progress[j+1]*100!\\fscy!progress[j+1]*100!)\\move(!xcen!,!ytext+offsetY[j]!,!xcen!,!ytext+offsetY[j+1]!,time[j],time[j+1])\\fs!size!}
Comment: 0,0:00:00.00,0:00:00.00,Text - Shout,,0,0,0,template line keeptags,!retime('line',0,200)!{\\an5\\fscx100\\fscy100\\t(!$ldur!,!$ldur+200!,\\fscx0\\fscy0)\\move(!xcen!,!ytext!,!xcen!,!ytext0!,!$ldur!,!$ldur+200!)\\fs!size!}
...
Comment: 0,0:00:00.00,0:00:00.00,Text - Cloud,,0,0,0,template noblank notext line,!retime('line',-150,200)!{\\p1\\an5\\bord0\\shad0\\c&HFFFFFF&\\clip(!xcen!,!y0!,!xcen!,!y0!)\\t(16.66,166.66,\\clip(!x1!,!y1!,!x2!,!y2!))\\t(!$ldur+140!,!$ldur+340!,\\clip(!xcen!,!y0!,!xcen!,!y0!))}m 0 0 l 1920 0 l 1920 1440 l 0 1440
Comment: 0,0:00:00.00,0:00:00.00,Text - Cloud,,0,0,0,template noblank line keeptags,!retime('preline',-150,50)!{\\an5\\fscx0\\fscy0\\t(16.66,166.66,\\fscx100\\fscy100)\\move(!xcen!,!ytext0!,!xcen!,!ytext!,16.66,166.66)\\fs!size!}
Comment: 0,0:00:00.00,0:00:00.00,Text - Cloud,,0,0,0,template noblank line keeptags,!retime('line',50,200)!{\\an5\\fscx100\\fscy100\\t(!$ldur-60!,!$ldur+140!,\\fscx0\\fscy0)\\move(!xcen!,!ytext!,!xcen!,!ytext0!,!$ldur-60!,!$ldur+140!)\\fs!size!}
`;
}

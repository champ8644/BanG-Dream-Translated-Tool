...
Comment: 0,0:00:00.00,0:00:00.00,ข้อความ,,0,0,0,code line,if name[_G.tonumber(line.actor)][2]==nil then nameFontSize=95 else nameFontSize=name[_G.tonumber(line.actor)][2] end
Comment: 0,0:00:00.00,0:00:00.00,ข้อความ,,0,0,0,template notext line,!retime("line", 0, 0)!{\\an7\\bord0\\shad0\\p1\\c&H7224EC&\\fscx150\\fscy500\\clip(106,1115,554,1181)\\pos(366.845,1050)!checkIfEmpty(name[$actor][1])!}m -200 5 l 200 5 200 32 -200 32
Comment: 0,0:00:00.00,0:00:00.00,ข้อความ,,0,0,0,template notext line,!retime("line", 0, 0)!{\\an7\\bord0\\shad0\\p1\\c&H!colorBackground!&\\pos(0,1441)!checkIfEmpty(line.text_stripped)!}m 77 -249 l 77 -52 b 77 -43 87 -23 109 -23 l 1807 -23 b 1819 -23 1835 -35 1835 -53 l 1835 -249 b 1835 -261 1821 -277 1805 -277 l 621 -277 b 622 -275 622 -273 621 -271 l 600 -250 l 112 -249 b 102 -249 92 -255 85 -266 b 81 -261 78 -256 77 -249
Comment: 0,0:00:00.00,0:00:00.00,ข้อความ,,0,0,0,template line keeptags,{\\clip(90,1198,1820,1403)}
Comment: 0,0:00:00.00,0:00:00.00,ข้อความ,,0,0,0,template notext line,!retime("line", 0, 0)!{\\1c&HFFFFFF&\\shad0.2\\fs!nameFontSize!\\pos(130,1150)\\an4}!name[$actor][1]!
...
Comment: 0,0:00:00.00,0:00:00.00,ข้อความสั่น,,0,0,0,code line,if name[act][2]==nil then nameFontSize=95 else nameFontSize=name[act][2] end
Comment: 0,0:00:00.00,0:00:00.00,ข้อความสั่น,,0,0,0,template notext line,!maxloop(_G.table.getn(shake[id])-1)! !retime("preline",shake[id][j].t,shake[id][j+1].t)!{\\an7\\bord0\\shad0\\p1\\c&H7224EC&\\fscx150\\fscy500\\clip(106,1115,554,1181)\\pos(!shake[id][j].x+366.845!,!shake[id][j].y+1050!)!checkIfEmpty(name[act][1])!}m -200 5 l 200 5 200 32 -200 32
Comment: 0,0:00:00.00,0:00:00.00,ข้อความสั่น,,0,0,0,template notext line,!maxloop(_G.table.getn(shake[id])-1)! !retime("preline",shake[id][j].t,shake[id][j+1].t)!{\\an7\\bord0\\shad0\\p1\\c&H!colorBackground!&\\pos(!shake[id][j].x!,!shake[id][j].y+1441!)!checkIfEmpty(line.text_stripped)!}m 77 -249 l 77 -52 b 77 -43 87 -23 109 -23 l 1807 -23 b 1819 -23 1835 -35 1835 -53 l 1835 -249 b 1835 -261 1821 -277 1805 -277 l 621 -277 b 622 -275 622 -273 621 -271 l 600 -250 l 112 -249 b 102 -249 92 -255 85 -266 b 81 -261 78 -256 77 -249
...
Comment: 0,0:00:00.00,0:00:00.00,ข้อความสั่น,,0,0,0,template notext line,!maxloop(_G.table.getn(shake[id])-1)! !retime("preline",shake[id][j].t,shake[id][j+1].t)!{\\an4\\1c&HFFFFFF&\\shad0.2\\fs!nameFontSize!\\pos(!shake[id][j].x+130!,!shake[id][j].y+1150!)}!name[act][1]!

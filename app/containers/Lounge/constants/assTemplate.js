...
Comment: 0,0:00:00.00,0:00:00.00,ข้อความ,,0,0,0,template notext line,!retime("line", 0, 0)!{\\blur0.1\\bord0\\shad0\\p1\\c&H!colorBackground!&\\fscx1500\\fscy1200\\clip(90,1198,1820,1296)\\t(0,2750,\\clip(1820,1198,1820,1296))!checkIfEmpty(line.text_stripped)!}m -120 -15 l 120 -15 120 13 -120 13
Comment: 0,0:00:00.00,0:00:00.00,ข้อความ,,0,0,0,template notext line,!retime("line", 0, 0)!{\\blur0.1\\bord0\\shad0\\p1\\c&H!colorBackground!&\\fscx1500\\fscy1200\\clip(90,1298,1820,1403)\\t(2750,5300,\\clip(1820,1298,1820,1403))!checkIfEmpty(line.text_stripped)!}m -120 -15 l 120 -15 120 13 -120 13
...
Comment: 0,0:00:00.00,0:00:00.00,ข้อความสั่น,,0,0,0,template notext line,!maxloop(_G.table.getn(shake[id])-1)! !retime("preline",shake[id][j].t,shake[id][j+1].t)!{\\blur0.1\\bord0\\shad0\\p1\\c&H!colorBackground!&\\fscx1500\\fscy1200\\clip(!shake[id][j].x+90!,!shake[id][j].y+1198!,!shake[id][j].x+1820!,!shake[id][j].y+1296!)\\t(!0-shake[id][j].t!,!2750-shake[id][j].t!,\\clip(!shake[id][j].x+1820!,!shake[id][j].y+1198!,!shake[id][j].x+1820!,!shake[id][j].y+1296!))!checkIfEmpty(line.text_stripped)!}m -120 -15 l 120 -15 120 13 -120 13
Comment: 0,0:00:00.00,0:00:00.00,ข้อความสั่น,,0,0,0,template notext line,!maxloop(_G.table.getn(shake[id])-1)! !retime("preline",shake[id][j].t,shake[id][j+1].t)!{\\blur0.1\\bord0\\shad0\\p1\\c&H!colorBackground!&\\fscx1500\\fscy1200\\clip(!shake[id][j].x+90!,!shake[id][j].y+1298!,!shake[id][j].x+1820!,!shake[id][j].y+1403!)\\t(!2750-shake[id][j].t!,!5300-shake[id][j].t!,\\clip(!shake[id][j].x+1820!,!shake[id][j].y+1298!,!shake[id][j].x+1820!,!shake[id][j].y+1403!))!checkIfEmpty(line.text_stripped)!}m -120 -15 l 120 -15 120 13 -120 13
`;
}

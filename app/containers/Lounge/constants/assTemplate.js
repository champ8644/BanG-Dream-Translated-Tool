...
Comment: 0,0:00:00.00,0:00:00.00,Credit,,0,0,0,code once,function isNonAlpha (bool) if (bool=="1") then return "\\\\alpha&H00&" end return "\\\\alpha&HFF&" end
...
Comment: 0,0:00:00.00,0:00:00.00,ชื่อสถานที่,,0,0,0,template notext line,!retime("line", -400, 400)!{\\p1\\bord0\\shad0\\fscx5000\\fad(400,400)\\c&H7745fa&\\fscy600\\clip(641,679,1727,755)\\t(0,400,\\clip(416,679,1502,755))\\t(1500,1900,\\clip(116,679,1202,755)\\pos(554,850)!checkIfEmpty(line.text_stripped)!}m -96 -11 l 140 -11 140 12 -96 12
Comment: 0,0:00:00.00,0:00:00.00,ชื่อสถานที่,,0,0,0,template notext line,!retime("line", -400, 400)!{\\p1\\bord0\\shad0\\fscx5000\\fad(400,400)\\c&HFFFEFF&\\fscy600\\clip(641,679,1727,755)\\t(0,400,\\clip(416,679,1502,755))\\t(1500,1900,\\clip(116,679,1202,755)\\pos(554,850)!checkIfEmpty(line.text_stripped)!}m -96 -11 l 140 -11 140 12 -96 12
...
Comment: 1,0:00:00.00,0:00:00.00,ฉากดำ,,0,0,0,code line,_, _,fadeIn,fadeOut,leftCom,rightCom = string.find(line.actor, "([%d.]*)%p*([%d.]*)%p*([%d.]*)%p*([%d.]*)"); fadeMid=(line.end_time-line.start_time-(fadeIn)-(fadeOut))/2+(fadeIn)
...
Comment: 2,0:00:00.00,0:00:00.00,ฉากดำ,,0,0,0,template notext line,!retime("line", 0, 0)!{\\an7\\bord0\\shad0\\p1\\c&H000000&\\fscx150\\fscy500\\clip(106,1115,554,1181)\\pos(366.845,1050)\\fade(!fadeIn!,!fadeOut!)!isNonAlpha(leftCom)!\\t(!fadeMid!,!fadeMid!,!isNonAlpha(rightCom)!)}m -200 5 l 200 5 200 32 -200 32
Comment: 1,0:00:00.00,0:00:00.00,ฉากขาว,,0,0,0,code line,_, _,fadeIn,fadeOut,leftCom,rightCom = string.find(line.actor, "([%d.]*)%p*([%d.]*)%p*([%d.]*)%p*([%d.]*)"); fadeMid=(line.end_time-line.start_time-(fadeIn)-(fadeOut))/2+(fadeIn)
...
Comment: 2,0:00:00.00,0:00:00.00,ฉากขาว,,0,0,0,template notext line,!retime("line", 0, 0)!{\\an7\\bord0\\shad0\\p1\\c&HFFFFFF&\\fscx150\\fscy500\\clip(106,1115,554,1181)\\pos(366.845,1050)\\fade(!fadeIn!,!fadeOut!)!isNonAlpha(leftCom)!\\t(!fadeMid!,!fadeMid!,!isNonAlpha(rightCom)!)}m -200 5 l 200 5 200 32 -200 32

...
Comment: 0,0:00:00.00,0:00:00.00,ข้อความสั่น,,0,0,0,template notext line,!maxloop(_G.table.getn(shake[id])-1)! !retime("preline",0,shake[id][j+1].t)!{\\alpha&HFFF&\\t(!shake[id][j].t!,!shake[id][j].t+1!,\\alpha&H000&)\\an7\\bord0\\shad0\\p1\\c&H733CFF&\\fscx150\\fscy500\\clip(106,1115,554,1181)\\pos(!shake[id][j].x+366.845!,!shake[id][j].y+1050!)}m -200 5 l 200 5 200 32 -200 32
Comment: 0,0:00:00.00,0:00:00.00,ข้อความสั่น,,0,0,0,template notext line,!maxloop(_G.table.getn(shake[id])-1)! !retime("preline",0,shake[id][j+1].t)!{\\alpha&HFFF&\\t(!shake[id][j].t!,!shake[id][j].t+1!,\\alpha&H000&)\\an7\\bord0\\shad0\\p1\\c&H!colorBackground!&\\fscx800\\fscy3500\\pos(!shake[id][j].x+957.2!,!shake[id][j].y+957!)\\clip(90,1198,1820,1407)}m -156 -15 l 120 -15 120 13 -156 13
Comment: 0,0:00:00.00,0:00:00.00,ข้อความสั่น,,0,0,0,template line,!maxloop(_G.table.getn(shake[id])-1)! !retime("preline",0,shake[id][j+1].t)!{\\alpha&HFFF&\\t(!shake[id][j].t!,!shake[id][j].t+1!,\\alpha&H000&)\\pos(!shake[id][j].x+125!,!shake[id][j].y+1200!)}
Comment: 0,0:00:00.00,0:00:00.00,ข้อความสั่น,,0,0,0,template notext line,!maxloop(_G.table.getn(shake[id])-1)! !retime("preline",0,shake[id][j+1].t)!{\\alpha&HFFF&\\t(!shake[id][j].t!,!shake[id][j].t+1!,\\alpha&H000&)\\an4\\1c&HFFFFFF&\\shad0.2\\fs95\\pos(!shake[id][j].x+130!,!shake[id][j].y+1150!)}!name[act]!
Comment: 0,0:00:00.00,0:00:00.00,ข้อความสั่น,,0,0,0,template notext line,!maxloop(_G.table.getn(shake[id])-1)! !retime("preline",0,shake[id][j+1].t)!{\\alpha&HFFF&\\t(!shake[id][j].t!,!shake[id][j].t+1!,\\alpha&H000&)\\blur0.1\\bord0\\shad0\\p1\\c&H!colorBackground!&\\fscx750\\fscy1200\\move(!shake[id][j].x+961!,!shake[id][j].y+1274!,!shake[id][j].x+3350!,!shake[id][j].y+1274!,0,2750)\\clip(!shake[id][j].x+90!,!shake[id][j].y+1198!,!shake[id][j].x+1820!,!shake[id][j].y+1296!)}m -120 -15 l 120 -15 120 13 -120 13
Comment: 0,0:00:00.00,0:00:00.00,ข้อความสั่น,,0,0,0,template notext line,!maxloop(_G.table.getn(shake[id])-1)! !retime("preline",0,shake[id][j+1].t)!{\\alpha&HFFF&\\t(!shake[id][j].t!,!shake[id][j].t+1!,\\alpha&H000&)\\blur0.1\\bord0\\shad0\\p1\\c&H!colorBackground!&\\fscx750\\fscy1200\\move(!shake[id][j].x+961!,!shake[id][j].y+1274!,!shake[id][j].x+3350!,!shake[id][j].y+1274!,2750,5300)\\clip(!shake[id][j].x+90!,!shake[id][j].y+1298!,!shake[id][j].x+1820!,!shake[id][j].y+1403!)}m -120 -15 l 120 -15 120 13 -120 13
`;
}
